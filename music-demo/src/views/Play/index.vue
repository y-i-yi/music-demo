      ...
      <div class="song-turn ani" :style="`animation-play-state:${playState ? 'running' : 'paused'}`">
        <div class="song-img">
          ...
          <img style="width: 100%" :src="`${
            imgSrc}?imageView&thumbnail=360y360&quality=75&tostatic=0`" alt="" />
        </div>
      </div>
      <!-- 播放按钮 -->
  ...
  export default {
    ...
    methods: {
      async getSong() { // 获取歌曲详情, 和歌词方法
        ...
        this.imgSrc = this.songInfo.al.picUrl  //songInfo.al.picUrl为歌曲图片网络地址
        // console.log(this.songInfo.al.picUrl)
